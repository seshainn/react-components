  ...
  return (
    <div className='flex flex-col justify-center items-center mt-20 space-y-2'>
      <div className='max-w-xl px-10 space-y-2'>
        <div className='flex items-center rounded-md bg-slate-300 dark:bg-teal-700 p-1'>
          <button
            autoFocus
            type='button'
            className='flex-grow bg-slate-300 dark:bg-teal-700 px-4 font-semibold text-center rounded-md py-1 focus:bg-slate-100 dark:focus:bg-teal-500'
        ...
        {tabSelected === 1 ? (
          <div className='italic space-y-5 rounded-md p-6 border-2 border-slate-300 dark:text-slate-300'>
